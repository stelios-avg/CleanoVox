...
const el = {
  ...
  'privacy.updated': 'Τελευταία ενημέρωση: {date}',
  'privacy.processors': 'Επεξεργαστές',
  ...
  'deleteAccount.bullet3':
    'Ποσά και ημερομηνίες κρατήσεων μένουν ανώνυμα για λογιστικά. Η συνδρομή Stripe ακυρώνεται.',
  ...
  'auth.privacyPrefix': 'Με την εγγραφή αποδέχεσαι την',
...
const en: Record<TranslationKey, string> = {
  ...
  'deleteAccount.bullet3':
    'Booking amounts and dates stay anonymised for accounting. Stripe membership is cancelled.',
  ...
  'auth.privacyPrefix': 'By signing up you accept the',
